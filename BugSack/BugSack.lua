...
function BugSack:OnInitialize()
	...
	self:RegisterChatCommand({"/bugsackcl", "/bscl"}, self.optionsTable)
	self:RegisterChatCommand({ "/bugsack", "/bs"}, function() waterfall:Open('BugSack') end)
	waterfall:Register('BugSack', 'aceOptions', self.optionsTable, 'title','BugSack 2.0. Revision: 12403','colorR', 0.2, 'colorG', 0.6, 'colorB', 0.2) 
